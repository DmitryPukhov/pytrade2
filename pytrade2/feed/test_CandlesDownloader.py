...
class TestCandlesDownloader(TestCase):
    ...
    def test_intervals_0days(self):
        intervals = CandlesDownloader.date_intervals(datetime.fromisoformat("2023-12-18"),
    ...
    def test_intervals_2days(self):
        intervals = CandlesDownloader.date_intervals(datetime.fromisoformat("2023-12-17"),
                                                     datetime.fromisoformat("2023-12-19"))
        self.assertListEqual(
    ...
    def test_last_days_2(self):
        actual = list(CandlesDownloader.last_days(datetime.fromisoformat("2023-12-18"), 2, '1min'))
    ...
    def test_last_days_1(self):
        actual = list(CandlesDownloader.last_days(datetime.fromisoformat("2023-12-18"), 1, '1min'))
        self.assertListEqual(
            [(datetime.fromisoformat("2023-12-18 00:01:00"), datetime.fromisoformat("2023-12-19 00:00:00"))], actual)

    def test_last_days_0(self):
        actual = list(CandlesDownloader.last_days(datetime.fromisoformat("2023-12-18"), 0, '1min'))
        self.assertListEqual(
            [], actual)
