...
from huobi.model.market.pricedepth_event import PriceDepthEvent, PriceDepth
...
class HuobiFeed:
    ...
    def run(self):
        ...
        """
        self.client = MarketClient(init_log=True, url="https://api.huobi.pro")

        self.client.sub_pricedepth(symbols=",".join(self.tickers),
