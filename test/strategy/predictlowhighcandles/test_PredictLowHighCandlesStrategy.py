...
class TestPredictLowHighCandlesStrategy(TestCase):
    ...
    def test_last_signal_none(self):
        signal, price, stop_loss, take_profit = TestPredictLowHighCandlesStrategy.new_strategy().last_signal(
    ...
    def test_multi_candles_last_signal_sell(self):
        ...
        signal, price, stop_loss, take_profit = TestPredictLowHighCandlesStrategy.new_strategy().last_signal(candles)
