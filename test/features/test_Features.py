...
class TestFeatures(TestCase):
    ...
    def test_features__(self):
        candles = pd.DataFrame([
            # 7:00-7:05
            {'close_time': datetime.fromisoformat('2021-12-08 07:00:01'), 'ticker': 'asset1', 'low': 1,'high': 11},
            {'close_time': datetime.fromisoformat('2021-12-08 07:00:10'), 'ticker': 'asset1', 'low': 1,'high': 11},
            {'close_time': datetime.fromisoformat('2021-12-08 07:01:00'), 'ticker': 'asset1', 'low': 2,'high': 22},
            # 7:05-7:10
            {'close_time': datetime.fromisoformat('2021-12-08 07:01:59'), 'ticker': 'asset1', 'low': 3,'high': 33},
            {'close_time': datetime.fromisoformat('2021-12-08 07:02:05'), 'ticker': 'asset1', 'low': 2,'high': 22},
            {'close_time': datetime.fromisoformat('2021-12-08 07:03:00'), 'ticker': 'asset1', 'low': 1,'high': 11},
