...
class TestHuobiFeedBase(TestCase):
    ...
    def test_interval_of_ch(self):
        self.assertEqual("1min", HuobiFeedBase.interval_of_ch("market.BTC-USDT.kline.1min"))
        self.assertEqual("15min", HuobiFeedBase.interval_of_ch("market.BTC-USDT.kline.15min"))
